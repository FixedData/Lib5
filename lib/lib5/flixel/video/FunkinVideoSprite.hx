...
enum abstract VideoOptions(String) to String
{
	/**
	 ...
	 * Usage:
	 * ```haxe
	 * video.load(Paths.video(''),[VideoOptions.looping]);
	 * ```
	 */
	 ...
	 * Usage:
	 * ```haxe
	 * video.load(Paths.video(''),[VideoOptions.muted]);
	 * ```
	 */
